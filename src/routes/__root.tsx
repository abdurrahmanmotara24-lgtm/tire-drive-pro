...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A modern, professional website for a tire company, designed to attract customers and generate leads." },
      { property: "og:description", content: "A modern, professional website for a tire company, designed to attract customers and generate leads." },
      { name: "twitter:description", content: "A modern, professional website for a tire company, designed to attract customers and generate leads." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/297b205f-bc2f-4b5c-8822-97a558ade2e5/id-preview-b29c9ee5--f830e90d-2ee7-4fbd-9b93-5cca7ea5ac43.lovable.app-1779358770271.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/297b205f-bc2f-4b5c-8822-97a558ade2e5/id-preview-b29c9ee5--f830e90d-2ee7-4fbd-9b93-5cca7ea5ac43.lovable.app-1779358770271.png" },
    ],
    links: [
