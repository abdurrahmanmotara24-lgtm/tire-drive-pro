...
import { isSupabasePublicEnvConfigured, readSupabasePublicEnv, SUPABASE_PUBLIC_ENV_HINT } from "@/lib/env";
...
function createSupabaseClient(): SupabaseClient | null {
  ...
  if (!url || !key) {
    console.warn(`[Supabase] Missing public credentials — ${SUPABASE_PUBLIC_ENV_HINT}`);
    return null;
  }
